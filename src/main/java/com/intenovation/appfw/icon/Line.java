...
public class Line implements PictureElement {
	private Point start;
	private Point end;
	...
	public Line(Line vorlage, int dx, int dy, String tooltip) {
		super();
	...
	public Line(Point start, Point end, String tooltip) {
		super();
	...
	public PictureElement deepClone() {
		...
		return new Line(this, 0, 0, tooltip + " Clone");
	}
}
