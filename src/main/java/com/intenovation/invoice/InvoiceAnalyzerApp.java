...
public class InvoiceAnalyzerApp {
    ...
    private List<Task> createTasks() {
        ...
        // Create the invoice processor task
        InvoiceProcessor processor = new InvoiceProcessor(emailDirectory, outputDirectory);
        TaskBuilder taskBuilder = new TaskBuilder("Invoice Processor")
