...
public class EnhancedInvoiceProcessor extends BackgroundTask {
    ...
    private List<Invoice> processMessage(Message message, ProgressStatusCallback callback) 
        ...
        Invoice baseInvoice = createBaseInvoice(messageId, message.getSubject(), from, messageDate);
     ...
     */
    private Invoice createBaseInvoice(String messageId, String subject, String from, Date sentDate) {
        Invoice invoice = new Invoice();
        
        // Set basic properties
        invoice.setEmailId(messageId);
        invoice.setSubject(subject != null ? subject : "");
